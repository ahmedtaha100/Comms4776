...
\begin{itemize}
    \item Model and Algorithms Research
    \begin{itemize}
        \item All Members
    \end{itemize}

    \item Model Training/Configurations/Evaluations
    \begin{itemize}
        \item ResNet-50: Robert Berman
        \item CLIP: Ahmed Taeha
        \item SigLIP: Darren Chan
    \end{itemize}
